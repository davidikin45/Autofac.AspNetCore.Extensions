...
{
    public abstract class DbContextIdentityTenantBase<TUser> : IdentityDbContext<TUser>, IDbContextTenantBase where TUser : IdentityUser
    {
        public DbContextIdentityTenantBase(DbContextOptions options, ITenantService tenantService)
            : base(options)
        {
        ...
        public DbContextIdentityTenantBase(ITenantService tenantService)
        {
            TenantService = tenantService;
        }
